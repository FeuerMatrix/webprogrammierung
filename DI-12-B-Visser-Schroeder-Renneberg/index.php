...
<body>
    ...
    <main>
        ...
        <p class="pad">
            <a href="<?=$hpath?>anmeldung.php">Melde dich an und leg los!</a>
        </p>
        <p class="pad">
            Hast du einen Account erstellt, so kannst du kannst du sogleich deinen ersten <a href="<?=$hpath?>eintragneu.php">Beitrag erstellen.</a> Schreib dir das Leid aus dem Herz und hänge ausreichend Bild- oder Videomaterial als Beweis an.<br>
            Du kannst ebenfalls <a href="<?=$hpath?>beitrag.php">von anderen Nutzern erstellten Einträgen</a> einsehen - dies geht sogar ohne Anmeldung!<br>
